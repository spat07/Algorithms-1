...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        /* YOUR CODE HERE */
    	//System.out.printf("Comparing points: (%d,%d),(%d,%d)\n",this.x, this.y, that.x, that.y);
    ...
    public static void main(String[] args) {
    	...
    	System.out.printf("Slopes: p1 -> p2 = %f, p2 -> p3 = %f, p3 -> p1 = %f\n, ", p1.slopeTo(p2), p2.slopeTo(p3), p3.slopeTo(p1));
    	
    	if (p1.slopeOrder().compare(p2, p3) == 0)
    		System.out.println("p1,p2,p3 are collinear!");
    	else
    		System.out.println("p1,p2,p3 are not collinear!");
